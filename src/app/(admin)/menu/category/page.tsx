...
const INITIAL: Category[] = [
  { id: "C-213014", name: "Pizza", assignedProducts: 17, status: "active" },
  { id: "C-213014", name: "Kebabs", assignedProducts: 3, status: "active" },
  {
    id: "C-213014",
    name: "Crispy Chicken",
    assignedProducts: 9,
  ...
  { id: "C-213014", name: "Burger", assignedProducts: 7, status: "active" },
  {
    id: "C-213014",
    name: "Championship",
    assignedProducts: 19,
  ...
  { id: "C-213014", name: "Sauces", assignedProducts: 7, status: "active" },
  { id: "C-213014", name: "Deserts", assignedProducts: 0, status: "active" },
  { id: "C-213014", name: "Drinks", assignedProducts: 12, status: "inactive" },
];
      ...
      <div className="bg-[#1a1a1a] rounded-2xl w-full max-w-125 mx-4">
        ...
        <div className="px-6 py-5 space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <div className="border-2 border-dashed border-white/15 rounded-xl p-8 text-center cursor-pointer hover:border-white/25 transition-colors">
              <CloudUpload size={32} className="mx-auto text-white/40 mb-2" />
              <p className="text-sm text-white/50">Upload an image</p>
              <p className="text-xs text-white/30 mt-1">
                Webp, JPEG, PNG Â· 48*48 px
              </p>
            </div>
          </div>
        </div>
    ...
    <div className="p-6 min-h-screen">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="relative">
          <select
            ...
            className="appearance-none bg-[#1a1a1a] border border-white/10 rounded-xl px-4 py-2.5 text-sm text-white outline-none cursor-pointer focus:border-white/20 scheme-dark"
          >
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-white/6">
              <th className="text-left px-5 py-4 text-xs font-medium text-white/40 uppercase tracking-wider">
                SL
              </th>
              <th className="text-left px-5 py-4 text-xs font-medium text-white/40 uppercase tracking-wider">
                Category ID
            ...
            {filtered.map((cat, idx) => (
              ...
              >
                ...
                <td className="px-5 py-4 text-sm text-white/70">
                  {String(cat.assignedProducts).padStart(2, "0")}
                </td>
                <td className="px-5 py-4">
      ...
      <div className="flex items-center justify-between mt-5">
        ...
        <div className="flex items-center gap-1">
          ...
          <button className="w-8 h-8 rounded-lg text-sm text-white/50 hover:text-white hover:bg-white/5">
            17
          </button>
        </div>
      </div>
